...
ActiveRecord::Schema.define(version: 2023_05_04_121224) do
  ...
  create_table "spree_image_footers", force: :cascade do |t|
    t.integer "number"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "spree_image_sliders", force: :cascade do |t|
    t.integer "number"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "url"
  ...
  create_table "spree_products", id: :serial, force: :cascade do |t|
    ...
    t.integer "count_size", default: 0
    t.boolean "existence", default: false
  ...
  create_table "spree_technical_supports", force: :cascade do |t|
    t.text "body"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
